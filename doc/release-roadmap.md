...
- Sprint 11: implemented and internally verified on 2026-07-16. The nested
  ...
  pitfall.
- Sprint 12: not started. One locally-runnable CI entry point, hosted CI that
  calls exactly it, and script-generated packaging/distribution material.
...
Status: not started. Decision: hosted CI is no longer deferred, but the local
