...
A. **`wm-type` droppt Zeichen, die einen Modifier brauchen.** „user@example.com"
   kam als „userexample.com" an (`@` fehlte), „https://…" als „https//…" (`:`
...
D. **`wm-type` liefert `+` und Leerzeichen korrekt** (2026-08-29: „+49 000 0000000"
